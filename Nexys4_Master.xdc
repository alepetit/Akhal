...
set_property PACKAGE_PIN E3 [get_ports H]
set_property IOSTANDARD LVCMOS33 [get_ports H]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports H]
...
set_property PACKAGE_PIN U8 [get_ports switch1]
...
set_property PACKAGE_PIN R2 [get_ports {led1}]
	set_property IOSTANDARD LVCMOS33 [get_ports {led1}]
###Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {led2}]
...
#set_property PACKAGE_PIN C12 [get_ports raz]
#set_property IOSTANDARD LVCMOS33 [get_ports raz]
...
set_property PACKAGE_PIN B13 [get_ports encs[0]]
set_property IOSTANDARD LVCMOS33 [get_ports encs[0]]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports encs[1]]
set_property IOSTANDARD LVCMOS33 [get_ports encs[1]]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports pwm]
...
#set_property PACKAGE_PIN D18 [get_ports {encI}]
#set_property IOSTANDARD LVCMOS33 [get_ports {encI}]
...
#connect_debug_port u_ila_0/clk [get_nets [list H_IBUF_BUFG]]
#set_property PROBE_TYPE DATA [get_debug_ports u_ila_0/probe0]
#set_property port_width 27 [get_debug_ports u_ila_0/probe0]
#connect_debug_port u_ila_0/probe0 [get_nets [list {encod/cpt_incr[0]} {encod/cpt_incr[1]} {encod/cpt_incr[2]} {encod/cpt_incr[3]} {encod/cpt_incr[4]} {encod/cpt_incr[5]} {encod/cpt_incr[6]} {encod/cpt_incr[7]} {encod/cpt_incr[8]} {encod/cpt_incr[9]} {encod/cpt_incr[10]} {encod/cpt_incr[11]} {encod/cpt_incr[12]} {encod/cpt_incr[13]} {encod/cpt_incr[14]} {encod/cpt_incr[15]} {encod/cpt_incr[16]} {encod/cpt_incr[17]} {encod/cpt_incr[18]} {encod/cpt_incr[19]} {encod/cpt_incr[20]} {encod/cpt_incr[21]} {encod/cpt_incr[22]} {encod/cpt_incr[23]} {encod/cpt_incr[24]} {encod/cpt_incr[25]} {encod/cpt_incr[26]}]]
#set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
#set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
#set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
#connect_debug_port dbg_hub/clk [get_nets H_IBUF_BUFG]
